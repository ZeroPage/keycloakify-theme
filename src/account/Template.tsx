...
export default function Template(props: TemplateProps<KcContext, I18n>) {
    ...
    return (
        <div className="bg-img min-h-screen flex flex-col items-center justify-center pt-4 px-8">
            ...
            <div data-aos="fade-up" className="max-w-7xl mx-auto text-3xl md:text-4xl text-white mb-10 tracking-tight font-extrabold px-6 text-left">
                What is ZeroPage?
            </div>
            <div data-aos="fade-up" className="max-w-7xl mx-auto pb-24 mb-4 text-lg font-normal text-white leading-loose text-justify break-all px-6" role="alert">
            ...
            <div data-aos="fade-up" className="max-w-7xl mx-auto text-3xl md:text-4xl tracking-tight text-white mb-10 md:mb-14 font-extrabold px-6 text-left">
                Events
            </div>
            <div data-aos="fade-up" className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12 pb-16 md:pb-24 px-6">
                <div className="h-content">
                    <a href="https://portal.zeropage.org/oms" className="text-xl md:text-2xl text-white font-semibold mb-2 md:mb-3 hover:underline">정모 & OMS</a>
                    <div className="text-base md:text-lg text-slate-400 keep-all">함께하는 성장! 매주 수요일 정모에 참여하여 앎을 공유하고 다른 제로페이지 회원들을 만나보아요!</div>
                </div>
                <div className="h-content">
                    <a href="https://portal.zeropage.org/sprouthon" className="text-xl md:text-2xl text-white font-semibold mb-2 md:mb-3 hover:underline">새싹교실 & 새싹톤</a>
                ...
                <div className="h-content">
                    <a href="https://portal.zeropage.org/devilscamp" className="text-xl md:text-2xl text-white font-semibold mb-2 md:mb-3 hover:underline">데블스캠프</a>
                ...
                <div className="h-content">
                    <a href="https://portal.zeropage.org/angelscamp" className="text-xl md:text-2xl text-white font-semibold mb-2 md:mb-3 hover:underline">엔젤스캠프</a>
                ...
                <div className="h-content">
                    <a href="https://portal.zeropage.org/jigeumgeuddae" className="text-xl md:text-2xl text-white font-semibold mb-2 md:mb-3 hover:underline">지금그때</a>
                ...
                <div className="h-content">
                    <a href="https://portal.zeropage.org/year-end-party" className="text-xl md:text-2xl text-white font-semibold mb-2 md:mb-3 hover:underline">기년회</a>
